  ...
  const filteredPrescriptions = useCallback(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(prescription =>
        ...
        prescription.userId.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        prescription.userId.email.toLowerCase().includes(searchTerm.toLowerCase())
      );
    }
        ...
        <div className="flex gap-3">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              setSortBy(field as 'date' | 'status');
